...
void runOnGraph(std::string path) {
    ...
    for (auto const& r : results) {
        ...
        printf("| %-16s | %17.0f | %7.2fx | %20lu |\n",
               ...
               time_ns, ratio, total_runs);
    }
    std::cout << "--------------------------------------------------------------------------------\n";
}
int main() {
    runOnGraph<long long>("../tests/graphs/random32D3.gr");
    runOnGraph<long long>("../tests/graphs/random256D3.gr");
    runOnGraph<long long>("../tests/graphs/random1024D3.gr");
    runOnGraph<long long>("../tests/graphs/random4096D3.gr");
    runOnGraph<long long>("../tests/graphs/random16384D3.gr");
    runOnGraph<long long>("../tests/graphs/grid5.gr");
    runOnGraph<long long>("../tests/graphs/grid25.gr");
    runOnGraph<long long>("../tests/graphs/grid100.gr");
